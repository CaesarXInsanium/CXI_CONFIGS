...
local base00 = hsl('#1f1e33') -- background
local base01 = hsl('#312f50') -- lighter background
local base02 = hsl('#040052') -- selection background
local base03 = hsl('#444270') -- comments, invisibvels, line highlighting
local base04 = hsl('#141320') -- dark foreground, status bars
local base05 = hsl('#d0cfe3') -- foreground, caret, operators
local base06 = hsl('#efeff6') -- light foreground
local base07 = hsl('#4e4b81') -- light background

local base08 = hsl'#87dfeb' -- variables, 
-- red
local base09 = hsl('#f02e6e') -- int, bool, constatns
-- green
local base0A = hsl('#62d196') -- class, struct
-- yellow
local base0B = hsl('#f2b482') -- strings
-- blue
local base0C = hsl('#65b2ff') -- support
-- magenta
local base0D = hsl('#a37acc') -- functions, methods
-- cyan
local base0E = hsl('#63f2f1') -- keywords
-- white
local base0F = hsl('#8a889d') -- extra color
...
local theme = lush(function()
  ...
  return {
    ...
    --                          gui = <string> },
    --
     Normal { bg = base00, fg = base05}, -- normal text
    ...
    -- We can make white space characters slighly visible
     ...
     Comment { fg=base03.saturate(9), gui="italic" },
