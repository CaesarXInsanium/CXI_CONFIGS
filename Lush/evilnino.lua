...
local base01 = hsl() -- lighter background
local base02 = hsl() -- selection background
local base03 = hsl() -- comments, invisibvels, line highlighting
local base04 = hsl() -- dark foreground, status bars
local base05 = base00.rotate(180) -- foreground, caret, operators
local base06 = hsl() -- light foreground
local base07 = hsl() -- light background
local base08 = hsl() -- variables, 
local base09 = hsl() -- int, bool, constatns
local base0A = hsl() -- class, struct
local base0B = hsl() -- strings
local base0C = hsl() -- support
local base0D = hsl() -- functions, methods
local base0E = hsl() -- keywords
local base0F = hsl() -- extra color
...
local theme = lush(function()
  return {
    ...
    TSFloat { fg = colors.normal.blue.saturate(50) }, -- For floats.
